<template>
  <div class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 h-[470px]">
    <img
      :src="survey.image_url || 'https://st3.depositphotos.com/23594922/31822/v/600/depositphotos_318221368-stock-illustration-missing-picture-page-for-website.jpg'"
    ...
    <div class="flex justify-between items-center mt-3">
      <router-link :to="{ name: 'surveyDetail', params: { id: survey.id } }"
      ...
      <div class="flex items-center">
        <a :href="`/surveys/${survey.slug}`" target="_blank"
        ...
        <button type="button" v-if="survey.id" @click="emit('delete', survey)"
